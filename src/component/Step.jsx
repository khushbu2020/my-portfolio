  ...
  <div className="container px-5 mx-auto flex flex-wrap">
    <div className="flex relative pt-4 pb-4 sm:items-center md:w-2/3 mx-auto">
      ...
      <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
        <div className="flex-shrink-0 w-24 h-24 bg-indigo-100 rounded-full inline-flex items-center justify-center" style={{color:"#f06529"}}>
    ...
    <div className="flex relative pb-4 sm:items-center md:w-2/3 mx-auto">
      ...
      <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
        ...
        <i className="fa-brands fa-css3-alt text-6xl" style={{color:"#2965f1"}}></i>
        </div>
        <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
          <h2 className="font-medium title-font text-gray-900 mb-1 text-xl">
            CSS
    ...
    <div className="flex relative pb-4 sm:items-center md:w-2/3 mx-auto">
      ...
      <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
        <div className="flex-shrink-0 w-24 h-24 bg-indigo-100 text-indigo-500 rounded-full inline-flex items-center justify-center">
        <i className="fa-brands fa-bootstrap text-6xl" style={{color:"#563d7c"}}></i>
        </div>
        <div className="flex-shrink-0 w-24 h-24 bg-indigo-100  text-indigo-500  rounded-full inline-flex items-center justify-center">
        <box-icon type='logo' name='tailwind-css' style={{color:"#3490dc"}}></box-icon>
        </div>
        <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
          <h2 className="font-medium title-font text-gray-900 mb-1 text-xl">
            Bootstrap / Tailwind
          ...
          <p className="leading-relaxed">
          Experienced in Bootstrap for rapid development of responsive websites. / Experienced in Tailwind CSS for rapid prototyping and styling.
          </p>
        </div>
      </div>
    </div>
    <div className="flex relative pb-4 sm:items-center md:w-2/3 mx-auto">
      ...
      <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
        ...
        <div className="flex-shrink-0 w-24 h-24 bg-indigo-100 text-indigo-500 rounded-full inline-flex items-center justify-center">
        <i className="fa-brands fa-js text-6xl" style={{color:"#f0db4f"}}></i>
        </div>
        <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
          <h2 className="font-medium title-font text-gray-900 mb-1 text-xl">
            Java Script
          ...
          <p className="leading-relaxed">
          Proficient in JavaScript for dynamic and interactive web experiences.
          </p>
        </div>
      </div>
    </div>
